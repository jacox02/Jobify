    ...
    <div>
      <Form className="FormPostulate" onSubmit = {this.enviarMensaje}>
        <Form.Group>
          ...
          <Form.Control type="text" name="email" onChange={this.Cambios}
          ref={this.email} />
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control type="text" name="number"  onChange={this.Cambios}
          ref={this.number}/>
        </Form.Group>
        <Form.Group>
          <Form.Label>
          ...
          <Form.Control as="textarea" name="mensaje" rows={3} onChange={this.Cambios}
          ref={this.mensaje} />
        </Form.Group>
        <Form.Group as={Row}>
          <Col>
